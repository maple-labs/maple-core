...
describe("Calculator - Full Repayment (Premium)", function () {
  ...
  it("C - Iterate through couple payments", async function () {
  ...
  it("D - Make a full payment after partial payments", async function () {
    ...
    PAYMENT_INFO = await LoanVault.getFullPayment();
    ...
    await DAI.approve(vaultAddress, PAYMENT_INFO[0]);
    await LoanVault.makeFullPayment();
