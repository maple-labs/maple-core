...
//         calcBPool      = new CalcBPool();                                               // Deploy the calculator library.
...
//         (calc_minStake, calc_stakerBal) = calcBPool.getPoolSharesRequired(address(bPool), USDC, address(sid), stakeLocker, minCover);
