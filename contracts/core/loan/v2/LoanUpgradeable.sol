...
import { PausableUpgradeable }      from "../../oz-upgrades/PausableUpgradeable.sol";


import { BasicFundsTokenFDTUpgradeable } from "../../funds-distribution-token/v1/BasicFundsTokenFDTUpgradeable.sol";
...
contract Loan is Initializable, ILoan, BasicFundsTokenFDTUpgradeable, PausableUpgradeable {
    ...
    function initialize(
        ...
        _pausable_initialize();
        _basicFundsTokenFDTUpgradeable_initialize("Maple Loan Token", "MPL-LOAN", _liquidityAsset);
    ...
    */
    ...
    function withdrawFunds() public override(ILoan, BasicFundsTokenFDTUpgradeable) {
        _whenProtocolNotPaused();
        super.withdrawFunds();
