...
import { ERC20Upgradeable } from "../../oz-upgrades/ERC20Upgradeable.sol";

/// @title BasicFDT implements the basic level FDT functionality for accounting for revenues.
abstract contract BasicFDTUpgradeable is Initializable, IBasicFDT, ERC20Upgradeable {
    ...
    function _basicFDTUpgradeable_initialize(string memory name, string memory symbol) internal initializer {
        _erc20_initialize(name, symbol);
    }
