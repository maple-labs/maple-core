...
contract MplRewardsTest is DSTest {
    ...
    function test_rewardsSingleEpoch() external {
        ...
        assertEq(rewardsContract.periodFinish(),                                      start + 30 days);
    ...
    function test_rewardsMultiEpoch() external {
        ...
        uint256 dTime1_rpt = (rewardsContract.rewardRate() * 30 days) / 40;
        ...
        assertEq(rewardsContract.lastUpdateTime(),           start + 30 days);
        assertEq(rewardsContract.lastTimeRewardApplicable(), start + 30 days);
