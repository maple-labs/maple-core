...
LANG=C.UTF-8 DAPP_SRC="contracts" hevm dapp-test --match "contracts/test/MapleGlobals.t.sol" --rpc="$ETH_RPC_URL" --json-file=out/dapp.sol.json --dapp-root=. --verbose 1
